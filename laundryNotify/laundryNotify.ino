...
uint32_t ip = cc3000.IP2U32(#,#,#,#); //replace # with your server IP
int port = 80;

// Server GET requests (Xively is not needed for this sketch to work)
const char machine_state[] = "GET /laundryInterface/data/machineStatus.txt HTTP/1.0\r\nConnection: close\r\n\r\n";
const char notifier_state[] = "GET /laundryInterface/data/notifierStatus.txt HTTP/1.0\r\nConnection: close\r\n\r\n";
const char notifier_off[] = "GET /laundryInterface/php/notifierOff.php HTTP/1.0\r\nConnection: close\r\n\r\n";
const char washer_done[] = "GET /laundryInterface/php/washerDone.php HTTP/1.0\r\nConnection: close\r\n\r\n";
const char dryer_done[] = "GET /laundryInterface/php/dryerDone.php HTTP/1.0\r\nConnection: close\r\n\r\n";
//const char reset_machines[] = "GET /laundryInterface/php/resetXively.php HTTP/1.0\r\nConnection: close\r\n\r\n";
...
String send_request (String request) {
    ...
    Serial.println(F("Querying the server..."));
    ...
    if (client.connected()) {
    	client.println(request);      
      	client.println(F(""));
      	Serial.println(F("Connected...request sent"));
    } 
    else {
...
void handleWasher(void) {
    Serial.println(F("Reading mic levels...")); 
    ...
    if (currentMillis - previousMillis > maxCycleTime) {
    	...
    	Serial.println(F("Wash cycle complete, sending text alert!"));
